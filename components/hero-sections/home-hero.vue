    ...
    <div class="w-full mx-auto max-w-5xl">
      <div class="hero-content flex-col lg:flex-row-reverse">
        ...
        <div>
          ...
          <p class="pt-6 pb-2">Je suis développeur front end depuis 2019 et je travaille principalement avec
            <a href="https://v3.nuxtjs.org/" target="_blank" title="Site NuxtJS" class="link link-accent">
            ...
            accessoirement
            <a href="https://www.typescriptlang.org/" target="_blank" title="Site VueJS" class="link link-accent">
          ...
          <p class="pb-6">Je travaille également avec
            <a href="https://developer.mozilla.org/fr/docs/Web/JavaScript" target="_blank" title="Site MDN Javascript" class="link link-accent">
            ...
            ,
            <a href="https://www.typescriptlang.org/" target="_blank" title="Site Typescript" class="link link-accent">
            ...
            et
            <a href="https://jquery.com/" target="_blank" title="Site jQuery" class="link link-accent">
            ...
            <a href="https://symfony.com/" target="_blank" title="Site Symfony" class="link link-accent">
